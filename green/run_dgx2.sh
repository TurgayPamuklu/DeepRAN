...
# srun /cta/users/tpamuklu/libraries/python3_env/bin/python hcran_heuristic.py
# srun /cta/users/tpamuklu/libraries/python3_env/bin/python hcran_gurobi.py
srun /cta/users/tpamuklu/libraries/python3_env/bin/python crosshaul_gurobi.py
##### srun /cta/users/tpamuklu/libraries/python3_env/bin/python __init__.py
#########################################################################################
##### srun /cta/users/tpamuklu/libraries/gurobi_env/bin/python gurobi.py
